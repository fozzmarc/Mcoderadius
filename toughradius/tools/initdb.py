...
def init_db(db):
    ...
    params = [
        ('system_name',u'管理系统名称',u'RADIUS管理控制台'),
        ('customer_system_name',u'自助服务系统名称',u'RADIUS自助服务中心'),
        ('customer_system_url',u"自助服务系统地址",u"http://account.counect.com"),
        ...
        ('weixin_qrcode',u'微信公众号二维码图片(宽度230px)',u'http://'),
        ...
        ('expire_notify_days','到期提醒提前天数',u'3'),
        ...
        ('smtp_server',u'SMTP服务器地址',u'mail.counect.com'),
        ('smtp_user',u'SMTP用户名',u'ymf_service@counect.com'),
        ('smtp_pwd',u'SMTP密码',u''),
        ('smtp_sender',u'SMTP发送人名称',u'运营计费中心'),
